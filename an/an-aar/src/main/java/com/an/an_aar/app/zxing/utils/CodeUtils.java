package com.an.an_aar.app.zxing.utils;
...
import com.an.an_aar.app.zxing.activity.DEncodeHintType;
import com.an.an_aar.app.zxing.fragment.CaptureFragment;
import com.an.an_aar.app.zxing.zxing.camera.BitmapLuminanceSource;
import com.an.an_aar.app.zxing.zxing.camera.CameraManager;
import com.an.an_aar.app.zxing.zxing.decoding.DecodeFormatManager;
...
public class CodeUtils {
    ...
    public static Bitmap createImage(String text, int w, int h, Bitmap logo) {
        ...
        try {
            ...
            Hashtable<DEncodeHintType, Object> hints = new Hashtable<DEncodeHintType, Object>();
            hints.put(DEncodeHintType.CHARACTER_SET, "utf-8");
            //容错级别
            hints.put(DEncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.H);
            //设置空白边距的宽度
            hints.put(DEncodeHintType.MARGIN, 0);
