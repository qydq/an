...
package com.an.an_aar.app.zxing.zxing.view;
...
//        resultPointColor = resources.getColor(R.color.possible_result_points);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            canvas.drawBitmap(((BitmapDrawable) (getResources().getDrawable(R.drawable.aar_qrcode_scan_line))).getBitmap(), null, lineRect, paint);
